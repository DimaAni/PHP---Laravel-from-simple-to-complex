...
<ol>
    ...
    <li>Будет создан массив $B из трёх целочисленных элементов: 100, 200 и 300.</li>
    <li>Будет выведено содержимое массива $B: Array ( [0] => 100 [1] => 200 [2] => 300 ).</li>
    <li>Будет выведена строка $B =, за которой последуют три пробела.</li>
    <li>Будет использован цикл for для поэлементного отображения массива $B.</li>
    <li>Будет создан массив $C с элементами разных типов: "Первый", 2 и 3.3.</li>
    <li>Будет выведено содержимое массива $C: Array ( [0] => Первый [1] => 2 [2] => 3.3 ).</li>
</ol>
<p>
